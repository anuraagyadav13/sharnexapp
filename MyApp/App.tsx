...
import PrincipalRSMscreen from './src/screens/principal/PrincipalRSMscreen';
import PrincipalCreateExamScreen from './src/screens/principal/PrincipalCreateExamScreen';
      ...
      <AuthProvider>
        <GestureHandlerRootView style={{ flex: 1 }}>
          ...
          >
            ...
            <Stack.Screen name="PrincipalRSM" component={PrincipalRSMscreen} />
            <Stack.Screen name="PrincipalCreateExamScreen" component={PrincipalCreateExamScreen} />
          </Stack.Navigator>
        </NavigationContainer>
