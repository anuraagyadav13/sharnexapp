...
const PrincipalAddStaffScreen = ({ navigation }: any) => {
  ...
  const handleSubmitStaff = async () => {
    if (!formData.firstName || !formData.lastName || !formData.email) {
      showToast(
        'Please provide at least the basic identity details.',
        'warning',
      );
  ...
  const indicatorStyle = useAnimatedStyle(() => {
    ...
    return {
      transform: [
        { translateX: withSpring(activeIndex * (SCREEN_WIDTH / TABS.length)) },
      ],
    };
  });
            ...
            <Animated.View entering={SlideInRight}>
              ...
              <View style={styles.faceEnrollCard}>
                ...
                <Text style={styles.enrollHint}>
                  Facial data enables automated clock-in/out via campus smart
                  terminals.
                </Text>
                <TouchableOpacity
              ...
              <View style={styles.legalNotice}>
                ...
                <Text style={styles.legalText}>
                  ...
                  institutional servers for security compliance.
                </Text>
              </View>
