...
const QuickActionCard = React.memo(({ title, desc, delay }: { title: string, desc: string, delay: number }) => (
  ...
  return (
    <View style={[styles.activityItem, !isLast && styles.activityItemBorder]}>
      <View style={[styles.activityAvatarBox, { backgroundColor: iconBgColor }]}>
        <IconComponent name={iconName} size={18} color="#FFFFFF" />
      </View>
...
const styles = StyleSheet.create({
  ...
  activityName: { fontSize: 15, fontWeight: '600', color: '#111827', marginBottom: 2 },
  activityAction: { fontSize: 13, color: '#6B7280', marginBottom: 4 },
