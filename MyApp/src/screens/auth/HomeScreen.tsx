...
const featuresData = [
  ...
  },
  {
    ...
    description:
      'Automated fee collection, payment tracking, and financial reports',
    isNew: true,
  },
  {
    icon: '📋',
  ...
  },
  {
    icon: '📝',
    title: 'Exams',
    description: 'Schedule, conduct, and manage examinations seamlessly',
  },
  {
    icon: '🏆',
    title: 'Results',
    description: 'Generate and publish results with detailed analytics',
  },
  {
    icon: '🧠',
    title: 'AI Attendance',
    description: 'Intelligent attendance system powered by machine learning',
    isComingSoon: true,
  },
];
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          >
            <Animated.View
              style={[styles.hamburgerLine, animatedTopLineStyle]}
            />
            <Animated.View
              style={[styles.hamburgerLine, animatedMiddleLineStyle]}
            />
            <Animated.View
              style={[styles.hamburgerLine, animatedBottomLineStyle]}
            />
          </ScaleButton>
        </View>
      </View>
      ...
      <View style={styles.heroSection}>
        ...
        <Text style={styles.heroDescription}>
          An all-in-one platform to streamline attendance, assignments,
          communication, and analytics for modern educational institutions.
        </Text>
      ...
      <View style={styles.featuresSection}>
        ...
        <Text style={styles.featuresSubtitle}>
          Discover powerful tools designed to streamline your educational
          ...
          {currentFeatures.map((feat, idx) => (
            <View key={idx} style={styles.featureCardCentered}>
              ...
              <View style={styles.badgeRow}>
                ...
                {feat.isComingSoon && (
                  <Text style={styles.comingSoonBadgeCentered}>
                    Coming Soon
                  </Text>
                )}
              </View>
              <Text style={styles.featureCardDescriptionCentered}>
                {feat.description}
              </Text>
            </View>
          ))}
        ...
        <View style={styles.paginationContainer}>
          ...
          <TouchableOpacity
            style={[
              ...
              currentFeaturePage === 1 && styles.pageNumberButtonActive,
            ]}
            onPress={() => setCurrentFeaturePage(1)}
          >
            <Text
              style={[
                ...
                currentFeaturePage === 1 && styles.pageNumberTextActive,
              ]}
            >
              1
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.pageNumberButton,
              currentFeaturePage === 2 && styles.pageNumberButtonActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.pageNumberText,
                currentFeaturePage === 2 && styles.pageNumberTextActive,
              ]}
            >
              2
            </Text>
      ...
      <View style={styles.pricingSection}>
        ...
        <Text style={styles.featuresSubtitle}>
          Start with a 30-day free trial. No credit card required. All plans
          include the same powerful features.
        </Text>
        ...
        <Text style={styles.pricingFooterText}>
          All prices in Indian Rupees (₹). Questions?{' '}
          <Text style={styles.pricingContactLink}>Contact our sales team</Text>
        </Text>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
          © 2026 Sharnex. All rights reserved.
        </Text>
      </View>

      {/* Heavy-Lift Absolute Positioned Reanimated Drawer (No Modal = Smooth Performance) */}
      <View
        style={[StyleSheet.absoluteFill, styles.drawerOverlay]}
      ...
      >
        ...
        <Animated.View style={[styles.drawer, animatedDrawerStyle]}>
          ...
          <View style={styles.menuItemsContainer}>
            {['Home', 'Features', 'About Us', 'Pricing', 'Contact'].map(
              (item, idx) => (
                <StaggeredFadeIn
                  key={idx}
                  index={idx}
...
const getStyles = (theme: any) =>
  StyleSheet.create({
    ...
    logo: { fontSize: 24, fontWeight: '800', color: theme.primary },
    ...
    moonIcon: { fontSize: 20, color: theme.text, lineHeight: 24 },
    menuButton: {
      width: 34,
      height: 34,
      justifyContent: 'center',
    ...
    secondaryButtonText: { color: theme.warning, fontSize: 16, fontWeight: '700' },
    heroImageContainer: {
      width: '100%',
      aspectRatio: 1.5,
      marginTop: 40,
    ...
    featureCardDescriptionCentered: {
      fontSize: 14,
      color: theme.subtext,
      lineHeight: 22,
      textAlign: 'center',
    ...
    pageButtonText: { color: theme.subtext, fontSize: 18, fontWeight: '500' },
    pageNumberButton: {
      width: 44,
      height: 44,
      borderRadius: 12,
    ...
    pricingBadgeText: { color: theme.primary, fontSize: 13, fontWeight: '700' },
    toggleContainer: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 12,
    ...
    pricingPlanDesc: { fontSize: 15, color: theme.subtext, marginBottom: 24 },
    pricingPrice: {
      fontSize: 36,
      fontWeight: '800',
      color: theme.text,
    ...
    pricingPeriod: { fontSize: 16, fontWeight: '500', color: theme.subtext },
    ...
    pricingDotActive: { backgroundColor: theme.primary },
    pricingFooterText: {
      fontSize: 13,
      color: theme.subtext,
      textAlign: 'center',
    ...
    pricingContactLink: { color: theme.primary, fontWeight: '700' },
    ...
    checkSquareText: { color: theme.primary, fontSize: 18, fontWeight: 'bold' },
    includedTitle: { fontSize: 17, fontWeight: '700', color: theme.text },
    includedGrid: { flexDirection: 'row', justifyContent: 'space-between' },
    includedColumn: { gap: 14 },
    includedItem: { fontSize: 14, color: theme.subtext, fontWeight: '500' },
    ...
    footerText: { fontSize: 14, color: theme.subtext, fontWeight: '500' },
    ...
    closeIcon: { fontSize: 26, color: theme.text, paddingBottom: 2 },
    menuItemsContainer: { gap: 32, marginBottom: 40 },
    drawerItem: { paddingVertical: 4 },
    drawerItemText: { fontSize: 17, fontWeight: '600', color: theme.text },
    drawerLoginButton: {
      width: '100%',
      height: 54,
      backgroundColor: theme.primary,
